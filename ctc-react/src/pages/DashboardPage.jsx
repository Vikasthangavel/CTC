...
import {
  getStudents, getInstructions, getParentReports, getAllParentReports,
    ...
    <>
      ...
      <div className="row mb-4">
        <div className="col stat-card">
          ...
          <Link to="/students" className="btn btn-success btn-sm" style={{ marginTop: '8px' }}>Manage →</Link>
        </div>
        <div className="col stat-card">
          <div className="stat-card__number text-info">📅</div>
          <div className="stat-card__label">Attendance</div>
          <Link to="/attendance" className="btn btn-info btn-sm" style={{ marginTop: '8px' }}>Mark Today →</Link>
        </div>
        <div className="col stat-card">
          <div className="stat-card__number text-warning">💰</div>
          <div className="stat-card__label">Fees</div>
          <Link to="/fees" className="btn btn-warning btn-sm" style={{ marginTop: '8px' }}>Manage →</Link>
        </div>
      </div>
            ...
            <div className="card-body">
              <form onSubmit={handleSendInstruction}>
                ...
                <div className="form-group">
                  ...
                  <textarea className="form-control" value={message} onChange={e => setMessage(e.target.value)} placeholder="Enter message..." required />
                </div>
          ...
          <div className="card">
            ...
            <div className="list-group">
              {instructions.length === 0 && (
                <div className="list-group-item text-center text-muted" style={{ padding: '24px' }}>No instructions sent yet.</div>
              )}
