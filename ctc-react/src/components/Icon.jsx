// Lightweight SVG icon component — replaces all emojis in the project
// Usage: <Icon name="home" size={18} />

const icons = {
  home: (
    <path strokeLinecap="round" strokeLinejoin="round" d="M3 12l2-2m0 0l7-7 7 7m-9 5v6m0 0h4m-4 0H7m10-6v6m0 0h-4m4 0h2" />
  ),
  students: (
    <path strokeLinecap="round" strokeLinejoin="round" d="M17 20h5v-2a4 4 0 00-5-3.87M9 20H4v-2a4 4 0 015-3.87M12 12a4 4 0 100-8 4 4 0 000 8zm6 4a3 3 0 10-6 0m6 0H9" />
  ),
  attend: (
  ...
  fees: (
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8v1m0 10v1M6 12H5m14 0h-1M7.05 7.05L6.34 6.34M17.66 17.66l-.71-.71M7.05 16.95l-.71.71M17.66 6.34l-.71.71" />
  ),
  reports: (
  ...
  cake: (
    <path strokeLinecap="round" strokeLinejoin="round" d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2v10zM7 10h10M7 14h6" />
  ),
  arrowLeft: (
